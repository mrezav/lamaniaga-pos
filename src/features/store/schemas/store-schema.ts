...
export const createStorePayloadSchema = z.object({
    ...
    address: createStoreSchema.shape.address,
    phoneNumber: createStoreSchema.shape.phoneNumber,
    logoUrl: z.string().url().optional(),
    bannerUrl: z.string().url().optional(),
});

export type CreateStorePayloadType = z.infer<typeof createStorePayloadSchema>;
